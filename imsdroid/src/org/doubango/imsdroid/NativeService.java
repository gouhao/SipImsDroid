		...
		mBroadcastReceiver = new BroadcastReceiver() {
			...
			public void onReceive(Context context, Intent intent) {
				...
				if(NgnRegistrationEventArgs.ACTION_REGISTRATION_EVENT.equals(action)){
					...
					Log.d(TAG, "ACTION_REGISTRATION_EVENT: type=" + args.getEventType());
				...
				if(NgnMessagingEventArgs.ACTION_MESSAGING_EVENT.equals(action)){
					...
					Log.d(TAG, "ACTION_MESSAGING_EVENT: type=" + args.getEventType());
				...
				if(NgnMsrpEventArgs.ACTION_MSRP_EVENT.equals(action)){
					...
					Log.d(TAG, "ACTION_MSRP_EVENT: type=" + args.getEventType());
					switch(args.getEventType()){
						case DATA:
				...
				// Invite Events
					...
					Log.d(TAG, "ACTION_INVITE_EVENT: mediaType=" + mediaType + ", type=" + args.getEventType());
					switch(args.getEventType()){							
						case TERMWAIT:
						case TERMINATED:
